...
## Impression et PDF du devis client

Après saisie et enregistrement du devis, l'éditeur propose deux boutons distincts : **Imprimer** ouvre l'impression du devis, et **Exporter PDF** explique le choix « Enregistrer au format PDF » dans la fenêtre d'impression du navigateur (sur Mac : menu PDF → Enregistrer au format PDF). L'export utilise la mise en page du devis imprimable et laisse le navigateur choisir l'emplacement du fichier. Il ne télécharge pas un PDF automatiquement sans dialogue. Test local : présence des deux boutons et invocation de l'impression depuis « Exporter PDF » après affichage des instructions.

## En-têtes et pieds de page ajoutés par le navigateur

Les règles d'impression de l'ERP suppriment les marges de page réservées par le navigateur à la date, à l'heure, au titre de l'onglet (« ERP NYSOA CONSTRUCT ») et à l'URL en bas. Une marge interne de 10 mm garde les documents lisibles ; le badge QR conserve son format propre. Ceci s'applique aux impressions et PDF obtenus depuis l'ERP. Si la prévisualisation du navigateur affiche encore ces mentions, décocher **En-têtes et pieds de page** dans ses réglages d'impression ; une page web ne peut pas forcer cette option sur tous les navigateurs et toutes les imprimantes. Contrôler la prévisualisation pour les documents longs ou multipages avant tirage. Vérification locale : présence des règles CSS et des instructions d'export ; le dialogue d'impression réel reste à contrôler sur l'Opera GX utilisé.
